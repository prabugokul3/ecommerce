    ...
    <div class="container">
        ...
        <form class="form" name='contactForm' method='post' action="{{ url('list')}}" enctype="multipart/form-data">
            ...
            <div class="form-control">
                ...
                <input type="number" name="price" id="price" onchange="gstcal()" value={{old('price')}}>
                <span>@error('price'){{$message}}@enderror</span>
            </div>
            <div class="form-control">
                <label for="text">Quantity:</label>
                <input type="number" name="quantity" id="quantity" onchange="gstcal()" value={{old('quantity')}}>
                <span>@error('quantity'){{$message}}@enderror</span>
            </div>
            <div class="form-control">
                <label for="text">GST:</label>
                <input type="number" name="gst" id="gst" onchange="gstcal()" value={{old('gst')}}>
                <span>@error('gst'){{$message}}@enderror</span>
            ...
            <div class="form-control">
                ...
                <input type="file" name="filename" id="image" value="value={{old('filename')}}" />
                <span>@error('filename'){{$message}}@enderror</span>
